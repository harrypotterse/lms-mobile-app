                    ...
                    if (provider?.courseDetailsResponse?.data?.details
                        ...
                        true) {
                          if (provider!.courseDetailsResponse!.data!.details
                            ...
                            final Uri url = Uri.parse('https://lms.null-safety.com/lms/live-class/zoom-join/${provider!.courseDetailsResponse!.data!.details
                            !.liveClasses?.first.id}/${provider!.courseDetailsResponse!.data!.details
                            !.liveClasses?.last.id}');
                            print(url);
