...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    super.initState();
    // Check user role when screen loads
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<RoleCheckProvider>().getRoleCheck();
    });
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<RoleCheckProvider>(
      builder: (context, roleProvider, child) {
        ...
        if (roleProvider.error != null) {
          return Center(child: Text(roleProvider.error!));
        }
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Show only one button based on user role
